...
class App extends React.Component<IProps, IState> {
  ...
  onChangeProductSelect(v: any, action: any) {
    ...
    if (!v || v.length === 0) {
      ...
      this.setState({ produtosSelecionados: v });
    }
  }
    ...
    return (
      <div className="App">
        ...
        <div className="graficos">
          <Mapa width={window.innerWidth * 0.3} height={window.innerHeight * 0.4}></Mapa>
          <AreasEmpilhadas width={window.innerWidth * 0.65} height={window.innerHeight * 0.9} variable={this.state.variable} produtosSelecionados={this.state.produtosSelecionados}></AreasEmpilhadas>;
        </div>
      </div >
    );
  }
